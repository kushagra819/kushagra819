...
<div style={{
  ...
  <div style={{ display:'flex', flexDirection:'column', marginLeft:'164px', gap:'8px' }}>
    <div style={{
  ...
  <div style={{
    ...
    <div style={{ display:'flex' }}>{'// R2 = 0.96 → ANN distillation'}</div>
...
<div style={{
  ...
  <div style={{ display:'flex', flexDirection:'column', gap:'5px', width:'100%' }}>
    ...
    {[
      ...
      ['self.best_score', '"R2 = 0.96  (ANN on distillation column)"'],
...
<div style={{
  ...
  <div style={{ display:'flex', flexDirection:'column', gap:'10px' }}>
    {[
      { label: '// core ML', tags: ['Python', 'NumPy', 'Pandas', 'Matplotlib', 'Scikit-learn'], op: '0.95' },
      { label: '// deep learning', tags: ['TensorFlow', 'Keras', 'CNN', 'RNN', 'Neural Networks'], op: '0.7' },
      { label: '// other', tags: ['Jupyter', 'SQL', 'Java', 'JavaScript', 'Next.js'], op: '0.45' },
    ].map(function(row) {
      return (
    ...
    {[
      {
        ...
        desc: 'DWSIM simulation (Benzene-Toluene) → ML surrogate. Linear Reg, RF & ANN. R2 = 0.96.',
...
<div style={{
  ...
  <div style={{ color:'rgba(33,187,133,0.2)', fontSize:'10px' }}>
